...
$(document).ready(function() {
    ...
    $.getJSON('/contacts', {"fields": "name"}, function(data) {
    ...
    $('#addContactConfirmed').click(function(event) {
        // TODO: input validation?
        if ($(this).data('formuse') === 'add') {
    ...
    // TODO empty search field on page reload, old value may stay in the input
